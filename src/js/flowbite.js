...
*/
  ...
  var tabs_Default = {
    defaultTabId: null,
    activeClasses:
      "text-customPurple hover:text-customPurple dark:text-customPurple dark:hover:text-customPurple border-customOrange dark:bordercustomOrange",
    inactiveClasses:
      "text-gray-500 hover:text-gray-500 dark:text-gray-400 border-gray-100 hover:border-gray-400 dark:border-gray-100 dark:hover:text-gray-500",
    onShow: function onShow() {},
  };
